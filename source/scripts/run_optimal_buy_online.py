...
if __name__ == "__main__":
    ...
    if coin_dict['max_buy_price_reached'] and coin_dict['action_flag'] == 'buy' and coin_dict['filled_flag'] == 0:
        ...
        print("Max buying price asked for was {}".format(coin_dict['max_buy_price']))
        print("Executed at an Optimized buying price of {}".format(coin_dict['buy_price']))
